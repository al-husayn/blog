...
const BlogPostAssistant = dynamic(
    () => import('@/components/blog-post-assistant').then((mod) => mod.BlogPostAssistant),
    { ssr: false },
);

export function DeferredBlogPostAssistant({ slug, title }: DeferredBlogPostAssistantProps) {
