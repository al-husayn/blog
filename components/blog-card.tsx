...
export function BlogCard({
    ...
    return (
        <Link
            href={url}
            className='group relative block h-full overflow-hidden rounded-xl border border-border bg-card shadow-sm transition-[transform,border-color,box-shadow] duration-200 ease-out hover:z-10 hover:-translate-y-1 hover:border-primary/40 hover:shadow-[0_14px_28px_-18px_oklch(0.18_0.04_253/0.55)] focus-visible:z-10 focus-visible:-translate-y-1 focus-visible:border-primary/40 focus-visible:shadow-[0_14px_28px_-18px_oklch(0.18_0.04_253/0.55)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring dark:hover:shadow-[0_18px_36px_-20px_oklch(0.06_0.02_253/0.85)] dark:focus-visible:shadow-[0_18px_36px_-20px_oklch(0.06_0.02_253/0.85)]'
        >
            <div className='flex h-full flex-col bg-background transition-colors duration-200 group-hover:bg-muted/40 group-focus-visible:bg-muted/40'>
                {thumbnail && (
                    <div className='relative w-full overflow-hidden aspect-16/10 sm:aspect-video md:aspect-4/3 lg:aspect-16/10'>
                        <Image
                            src={thumbnail}
                            alt={title}
                            fill
