...
export const metadata: Metadata = {
    title: 'About',
    description: 'Learn more about Al-Hussein and the mission behind Learn. Build. Share.',
    alternates: {
        canonical: '/about',
    },
    openGraph: {
        title: `About | ${siteConfig.name}`,
        description: 'Learn more about Al-Hussein A. and the mission behind Learn. Build. Share.',
        type: 'profile',
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                        ...
                        <div className='max-w-3xl'>
                            ...
                            <p className='text-muted-foreground text-sm md:text-base lg:text-lg'>
                                ...
                                stories from my journey in software development.
                            </p>
                            <div className='mt-6 flex flex-wrap gap-3 text-xs md:text-sm'>
                                ...
                                <p className='inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1.5'>
                                    ...
                                    <span className='font-medium'>{allPages.length}</span> published
                                    articles
                                </p>
                                <p className='inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1.5'>
                                    <Layers className='h-4 w-4 text-primary' />
                                    <span className='font-medium'>{topicCount}</span> core topics
                                    covered
                                </p>
                            </div>
                        </div>
                ...
                <article className='space-y-6'>
                    <div className='rounded-xl border border-border bg-card p-6 space-y-3'>
                        ...
                        <p className='text-muted-foreground'>
                            ...
                            <span className='font-semibold text-foreground'>learn</span> core
                            concepts, <span className='font-semibold text-foreground'>build</span>{' '}
                            practical projects, and{' '}
                            <span className='font-semibold text-foreground'>share</span> knowledge
                            that helps the next person move faster.
                        </p>
                        <p className='text-muted-foreground'>
                            You&apos;ll find practical guides, architecture breakdowns, and lessons
                            from real implementation work, written to be useful in day-to-day
                            engineering.
                        </p>
                    </div>
