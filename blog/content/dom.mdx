---
title: "DOM Manipulation: How Browsers Represent Web Pages"
...
The **[`closest()`](https://developer.mozilla.org/en-US/docs/Web/API/Element/closest)** method is useful for event delegation (see [Event Loop](/blog/event-loop) for how events are processed):
...
Understanding how browsers render pages helps you write performant code. This is where [JavaScript Engines](/blog/javascript-engines) and the browser's rendering engine work together.
...
- Less memory usage
- Easier cleanup (uses [closures](/blog/scope-and-closures) to maintain handler references)
...
<CardGroup cols={2}>
  ...
  <Card title="Design Patterns" icon="puzzle-piece" href="/blog/design-patterns">
