---
title: "HTTP & Fetch API: Making HTTP Requests the Modern Way"
...
author: "al"
thumbnail: "/thumbnails/fetch.png"
---
...
<Warning>
**Prerequisite:** This guide assumes you understand [Promises](/blog/promises) and [async/await](/blog/async-await). Fetch is Promise-based, so you'll need those concepts. If you're not comfortable with Promises yet, read that guide first!
</Warning>

## What is HTTP?

**[HTTP](https://developer.mozilla.org/en-US/docs/Web/HTTP)** (Hypertext Transfer Protocol) is the foundation of data communication on the web. Its current HTTP semantics are defined in [RFC 9110](https://www.rfc-editor.org/rfc/rfc9110), with caching specified in [RFC 9111](https://www.rfc-editor.org/rfc/rfc9111). Every time you load a webpage, submit a form, or fetch data with JavaScript, HTTP is the protocol making that exchange possible.
...
The examples above use `.then()` chains, but modern JavaScript has a cleaner syntax: `async/await`. If you're not familiar with it, check out our [async/await concept](/blog/async-await) first. It'll make your fetch code much easier to read.
...
<CardGroup cols={2}>
  <Card title="Promises" icon="handshake" href="/blog/promises">
    Fetch is Promise-based — you need to understand Promises first
  </Card>
  <Card title="async/await" icon="hourglass" href="/blog/async-await">
    Modern syntax for working with Promises and fetch
  </Card>
  <Card title="Event Loop" icon="arrows-spin" href="/blog/event-loop">
    How JavaScript handles async operations like fetch
  </Card>
  <Card title="DOM" icon="sitemap" href="/blog/dom">
