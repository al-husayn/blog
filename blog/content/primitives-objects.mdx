...
<CardGroup cols={2}>
  <Card title="Primitive Types" icon="atom" href="/primitive-types">
    Deep dive into the 7 primitive types and their characteristics
  </Card>
  <Card title="JavaScript Engines" icon="microchip" href="/javascript-engines">
    How V8 compiles and optimizes your code, including memory management
  </Card>
  <Card title="Type Coercion" icon="shuffle" href="/type-coercion">
    How JavaScript converts between types automatically
  </Card>
  <Card title="Scope and Closures" icon="layer-group" href="/scope-and-closures">
