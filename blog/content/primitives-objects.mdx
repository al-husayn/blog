...
author: "al-hussein"
thumbnail: "/thumbnails/primitives-objects.webp"
---
...
<Warning>
**Prerequisite:** This guide assumes you understand [Primitive Types](/blog/primitive-types). If you're not familiar with the 7 primitive types in JavaScript, read that guide first!
</Warning>
...
<Tip>
**Want to go deeper?** Check out our [JavaScript Engines](/blog/javascript-engines) guide for more on V8 internals, JIT compilation, and optimization.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="JavaScript Engines" icon="microchip" href="/blog/javascript-engines">
