---
title: "JavaScript Engines: How V8 Runs Your Code"
...
author: "al"
thumbnail: "/thumbnails/js-engine.png"
---
...
<Warning>
**Prerequisite:** This guide assumes you're comfortable with basic JavaScript syntax. Some concepts connect to the [Call Stack](/blog/call-stack) and [Event Loop](/blog/event-loop), so reading those first helps!
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Event Loop" icon="rotate" href="/blog/event-loop">
  ...
  <Card title="Primitives vs Objects" icon="code-branch" href="/blog/primitives-objects">
