...
<CardGroup cols={2}>
  <Card title="Call Stack" icon="layer-group" href="/call-stack">
    How JavaScript tracks function execution and manages scope
  </Card>
  <Card title="Hoisting" icon="arrow-up" href="/beyond/hoisting">
    Deep dive into how JavaScript hoists declarations
  </Card>
  <Card title="IIFE, Modules and Namespaces" icon="box" href="/iife-modules">
    Patterns that leverage scope for encapsulation
  </Card>
  <Card title="this, call, apply and bind" icon="bullseye" href="/this-call-apply-bind">
    Understanding execution context alongside scope
  </Card>
  <Card title="Higher Order Functions" icon="arrows-repeat" href="/higher-order-functions">
    Functions that return functions often create closures
  </Card>
  <Card title="Currying & Composition" icon="wand-magic-sparkles" href="/currying-composition">
