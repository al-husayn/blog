...
author: 'al'
thumbnail: '/thumbnails/event-loop.webp'
---
...
<Warning>
**Prerequisites:** This guide assumes familiarity with [the call stack](/blog/call-stack) and [Promises](/blog/promises). If those concepts are new to you, read them first!
</Warning>
...
<AccordionGroup>
  <Accordion title="Call Stack">
    The **[Call Stack](/blog/call-stack)** is where JavaScript keeps track of what function is currently running. It's a LIFO (Last In, First Out) structure, like a stack of plates.
  ...
  <Accordion title="Microtask Queue">
    ...
    - Code after `await` in [async functions](/blog/async-await)
...
<CardGroup cols={2}>
  ...
  <Card title="async/await" icon="clock" href="/blog/async-await">
