...
<CardGroup cols={2}>
  ...
  <Card title="Primitives vs Objects" icon="clone" href="/primitives-objects">
    How primitives and objects behave differently during coercion
  </Card>
  <Card title="Equality Operators" icon="equals" href="/equality-operators">
    Deep dive into ==, ===, and how coercion affects comparisons
  </Card>
  <Card title="JavaScript Engines" icon="gear" href="/javascript-engines">
