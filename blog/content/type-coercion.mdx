...
author: "al-hussein"
thumbnail: "/thumbnails/type-coercion.webp"
---
...
<Warning>
**Prerequisites:** This guide assumes you understand [Primitive Types](/blog/primitive-types). If terms like string, number, boolean, null, and undefined are new to you, read that guide first!
</Warning>
...
Here's the most important rule: **JavaScript can only convert to THREE [primitive types](/blog/primitive-types):**
...
When JavaScript needs to convert an [object to a primitive](/blog/primitives-objects) (including arrays), it follows a specific algorithm.
...
The loose equality operator `==` is where type coercion gets wild. For a deeper dive into all equality operators, see our [Equality Operators guide](/blog/equality-operators). Here's how `==` actually works:
...
<CardGroup cols={2}>
  <Card title="Primitive Types" icon="atom" href="/blog/primitive-types">
    Understanding the basic data types that coercion converts between
  </Card>
  <Card title="Primitives vs Objects" icon="clone" href="/blog/primitives-objects">
    How primitives and objects behave differently during coercion
  </Card>
  <Card title="Equality Operators" icon="equals" href="/blog/equality-operators">
    Deep dive into ==, ===, and how coercion affects comparisons
  </Card>
  <Card title="JavaScript Engines" icon="gear" href="/blog/javascript-engines">
