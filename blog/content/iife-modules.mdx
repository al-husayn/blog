---
title: "IIFE, Modules & Namespaces: Structuring Code"
...
<Warning>
**Prerequisite:** This guide assumes you understand [scope and closures](/blog/scope-and-closures). IIFEs and the module pattern rely on closures to create private variables. If closures feel unfamiliar, read that guide first!
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Design Patterns" icon="compass" href="/blog/design-patterns">
    Common patterns for organizing code, including the module pattern
  </Card>
  <Card title="Call Stack" icon="bars-staggered" href="/blog/call-stack">
