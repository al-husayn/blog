...
author: "al"
thumbnail: "/thumbnails/recursion.jpg"
---
...
<Warning>
**Prerequisite:** This guide assumes you understand [JavaScript functions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Functions). It also helps to know how the [call stack](/blog/call-stack) works, though we'll cover that relationship here.
</Warning>
...
Recursion really shines when working with **nested or tree-like structures**. These [data structures](/blog/data-structures) are naturally recursive, and recursion is often the most elegant solution.
...
This pattern combines recursion with [higher-order functions](/blog/higher-order-functions) (the callback). It's how browser developer tools display the DOM tree and how libraries traverse HTML structures.
...
<CardGroup cols={2}>
  ...
  <Card title="Higher-Order Functions" icon="function" href="/blog/higher-order-functions">
    Functions that take or return other functions. Many recursive patterns combine with higher-order functions.
  </Card>
  <Card title="Data Structures" icon="sitemap" href="/blog/data-structures">
    Trees, linked lists, and graphs — data structures that are naturally recursive.
  </Card>
  <Card title="Pure Functions" icon="sparkles" href="/blog/pure-functions">
