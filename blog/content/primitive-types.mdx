...
author: "al"
thumbnail: "/thumbnails/primitive.webp"
---
...
<Tip>
Learn more about how JavaScript converts between types in the [Type Coercion](/blog/type-coercion) section.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="== vs === vs typeof" icon="equals" href="/blog/equality-operators">
    Understanding equality operators and type checking
  </Card>
  <Card title="Scope & Closures" icon="layer-group" href="/blog/scope-and-closures">
